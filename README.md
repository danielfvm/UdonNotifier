...
## Installation
Download the prefab from releases, double click on the `.unitypackage` and in Unity click on `Import`. Make sure to import TextMeshPro Assets if you haven't already!
